<div id="searchBar">
    ...
    <div id="searchForStuff" data-search-controller-url="{$search_controller_url}">
        <ul id="searchForStuffUl">
            <li id="searchForStuffLi1">
                <a onclick="closeSearchBar()" id="closeSearchBar">
                    <i class="material-icons">🗙</i>
                </a>
            </li>
            <li id="searchForStuffLi2">
...
<div id="search_widget_basic" class="col-lg-4 col-md-5 col-sm-12 search-widget" data-search-controller-url="{$search_controller_url}">
    <form method="get" action="{$search_controller_url}">
        <input type="hidden" name="controller" value="search">
        <input type="text" name="s" value="{$search_string}" placeholder="{l s='Search our catalog' d='Shop.Theme.Catalog'}">
        <button type="submit">
